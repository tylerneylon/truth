...
""" truth_imgs.py
    ...
    This is a simple static server to help develop images for a little book
    about truth.

    Run this as:

        ./truth_imgs.py          # to serve on port 80; or
        ./truth_imgs.py --debug  # to serve on port 8080, with verbose output.
"""
