...
As an example, consider the idea that water boils at 100\degree C.
...
\begin{claim}
    Cell $x$ will be on in the next time step if and only if 3 or 4 neighboring
    cells are on in the previous time step.
\end{claim}
...
It is about a fictional event in a widely-known
fictional story. For many stories, we could simply ask the author, since the
author has a kind of authority over what ``really happened'' in the story they
...
associated with the original author. We're examining a new kind of truth:
\begin{defn}[Authoritative Truth]
    A narrative idea is true when the party recognized as the authority on the
    narrative claims the idea to be correct.
\end{defn}
...
Yes, it is a different kind of truth, but it's still one that we discuss and
care about. If a kid asked you where Santa Claus lives, you would tell them he
lives at the North Pole. There is a shared narrative; if you were to say he
lives at the South Pole, this would feel incorrect.

You may be tempted to say that fictional stories have no place in a discussion
of truth because they are not about things that happened in reality. In
response, I'll point out that something {\em did} happen in reality, which is
that someone told a story which appealed to us. If the story has enough appeal,
...
to be so, that I'll include this kind of truth:
...
utensil etiquette, the result seems to be an expression of cultural status.
