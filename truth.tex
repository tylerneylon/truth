...
The truth of many ideas depends on how we test it (observation \ref{o6}).
...
created for practical purposes. These notions are imperfect in that they are
either about reality and based on approximate or finite correspondence, or
they are abstract ideas that exist purely in our minds, such as mathematics.
I'll summarize these recent ideas as:
\begin{obs}\label{o9}
    The knowledge of our day-to-day lives is based largely on fuzzy notions
    (like species) and
    arbitrary ideas (like laws),
    so that there are often no objectively correct answers to
    questions we can ask.
    In practice, many ideas we casually call ``true'' are known to be partial or
    approximate (like Newtonian mechanics), and we still accept them.
\end{obs}
...
% HERE
% See my notes from my whiteboards. I used Adobe Scan and saved it in a pdf
% called Scan 4, 2022 (1) I believe. Also took photos (in my Photos app).
% ___
