...
about the inputs.
If something seems like a probability, such as whether it will
...
\begin{argt}[That example-based concepts are fuzzy]
    ...
    \begin{itemize}
        ...
        \item Perhaps we've never seen such an example, but it's logically
            ...
            of $p$\,-values seen on examples of concept $x$. Similarly, $p_y$
        ...
        \item Note: It's not necessary that these confusing objects are ever
            actually seen in reality: If a concept were truly clear, then
            any
            object we could ever encountered would have a definite label
            associated with the concept. Even the logical possibility of
            encountering an indefinite (unclear) object shows the concept to
...
definition you have in mind. Contrast this with a less-common type of concept
...
Since most of our concepts are learned by example, the conclusion is that
...
concept always has an unambiguous relationship to objects), and instead
