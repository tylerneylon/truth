...
I'll argue that our concept of truth is a human invention, bringing with it an
arbitrariness, and unresolved edge cases. Our very idea of truth is not itself a
discovered aspect of reality, but rather something we have imposed upon reality,
and this has profound ramifications on how we, humans, ought to view both
...
-- is
precise and final, never to be noticed in retrospect as incorrect in
some way. So one downfall of the scientific method is our acceptance that it
...
each partially explain all of the known relevant evidence. Then we must decide
...
another. These are common occurrences in communities looking for progress in
their fields, whether that field is physics, computer science, or even, giving
...
Today's scientific method is an
ever-evolving, approximate guideline.
It's worthwhile to explicitly help its evolution.

Question \ref{q2} has many practical applications. It may even
be the ultimate practical question -- this is the motivation I promised.
When you open the door toward answering this, you find the
Pandora's box that is question \ref{q1}.

{\bf NEXT} State, very briefly, the conclusion that I'll reach. I think I should
insanely briefly state it at the very very top, and then give it something like
a paragraph here.
