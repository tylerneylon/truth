...
To provide an answer, we'll need to analyze what makes some things true and
others false, especially in cases where the distinction is not obvious.
We'll consider the kinds of things that can be true or false:
...
By the end of this article, I'll have proposed ten
observations that elucidate the nature of truth, and
I'll be able to summarize this article's perspective on
what truth is.
...
({\em How can we learn what's true?}) within this article,
...
{\em correspondence theory}, first mentioned
...
% TODO Maybe clarify this as the first answer to the above question.
