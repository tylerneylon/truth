...
We can boil some water with a thermometer to test this. Of course,
...
\begin{itemize}
    \item We're assuming that any laws of physics at all exist.
...
quite right because it glosses over the other kinds of truth that I'll talk
...
fired at Han, but in later, edited, versions of the film, Greedo either shot at
Han first or nearly simultaneously.

I don't think claim \ref{c1} is verifiable in the same way as the claim that
water boils at 100\degree C.
It's an interesting claim because its
truth is non-obvious. It is about a fictional event in a widely-known
