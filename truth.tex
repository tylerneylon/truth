...
I'll show you some example questions to drive home the intuition behind this
idea, and then present a general argument.

I'll give you three questions to help build up an intuition about the role of
ignorance in ideas and truth. In order to state these questions, I'll define a
...
divisible by 3?'' because the answer is obvious. Depending on how profoundly
familiar you feel with commute times, question {\bf Q1} may even feel to you
like ``Is blue blue?'' which is so much like question {\bf Q3} that you might
find it confusing.
...
% HERE1 Clean up the above few paragraphs. I think they can be both more clear
...
\begin{argt}[That ideas only make sense in the presense of ignorance.]
    ...
    \begin{itemize}
        ...
        \item A question only makes sense if we can imagine that the world may
            have possible states where the answer is different.
...
% HERE2 See my notes in my remarkable.
% 
