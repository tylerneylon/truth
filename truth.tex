...
\begin{defn}[Verifiable Truth]
    ...
    either supports or refutes the idea.
\end{defn}
...
Something at first feels wrong.
...
For example, a cloudless daytime sky is blue.
It seems there's no goal to be achieved by knowing the sky is blue,
so that the fact is not effective (is not goal-based) while
still being true.
...
\end{answer}
With that answer in mind, the rest of this article focuses on effective truth.
