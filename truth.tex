...
{\bf Truth Is Not the Foundation of Human Knowledge}
...
in this paper, I mean that the goal of the idea (eg, road safety) is more
...
\begin{argt}[That Social Ideas are Arbitrary]
    ...
    \begin{itemize}
        ...
        \item Combining the above:
            How a social idea is implemented is less important than that it is
...
\section{The Foundation of Human Knowledge}
...
encounter in their daily lives. I'm including that example because it shows how
a direct logical contradiction can be believed. But let's also look at a less
axiomatic example. Imagine a person who has lived in New York City their entire
lives. Suppose they think of doves as pure white birds, symbols of peace of
cleanliness. With that understanding, they may honestly believe that they have
never seen a wild dove. However, if you see a pigeon in New York, it's
almost certain that you're looking at a {\em Columba livia} --- also known as a
{\em rock dove}. That is, pigeons and doves are, to some degree, the same
animals. Like the word {\em vegetable}, the non-scientific terms {\em dove} and
{\em pigeon} are fuzzy, but they overlap heavily, and in many languages the
analogs of {\em dove} and {\em pigeon} are synonyms. This is another example
where intuition --- that you see wild pigeons every day, that you've never seen
a wild dove --- may directly contradict itself.

I'll summarize this line of thinking:
\begin{obs}\label{o10}
...
make a list of all the actions you take and the decisions you make throughout
the day, you'll find that most of them --- quite possibly all of them --- 
are practical decisions. In other words, while supertruth is an idea we know
about, it's a relatively obscure version of truth that we only use in a
fraction of academically-oriented settings. This article is focused on what
people do in practice, and how they think most often; that's why this article
has focused on the ``actually-used'' notion of effective truth.
...
% Does this mean that truth is not real?
% I've argued that truth is an invented notion, and that it is typically
% imperfect and dependent on humans imperfection to make any sense. This is not
% the same as not being real. For example, consider chairs. They are invented,
% typically imperfect, and only make sense to a person who thinks in terms of
% sitting down in chairs, which for now is essentially just humans. And chairs
% are real.
%
% Does this mean that we cannot believe in ideas as being completely true?
% For all practical purposes, many ideas are true. It seems that in practice
% some ideas have 99.99+% certainty, and this is more-or-less the most we will
% ever see, and we may as well treat them as absolutely true.
%
% Maybe the outcome of this paper is that we just keep doing things exactly the
% way we have done them before. If that's true, then what is the value of this
% article? In the sense of effective truth, it may appear to be ineffective, and
% thus false. But I think it does change how we think about things. For example,
% consider an argument between two programmers about how to best write a
% particular function. In practice, there is often an underlying sense that one
% of the two people must be correct. With the perspective of this paper, we can
% shift our view to see this as two people selling products that do the same
% thing. In one sense, one product may be superior to the other, such as if we
% arrive at a repeatable quantification of quality. But in another critical
% sense, we understand that there is no underlying singularly correct answer.
% Rather, we are negotiating amongst ourselves. When we recognize that fact, it
% can facilitate our feelings and communications between each other. It can give
...
% uncertainty (since we essentially always have uncertainty). Put simply, this
% article throws
% a glass of cool water in the face of dichotomous thought.
%
% What does this mean about the world? Basically nothing, it is about us. What
% does it mean about us? It means that things about us that sometimes seem
% mystical and to be deep mysteries of the universe are probably less special --
% and therefore also more accessible -- than we first think. Emotions.
% Consciousness. Human uniqueness in the universe. Intelligence. Creativity.
% Mortality.
%
% Just to look a single example, consider our feeling that we're along in the
% universe. It's mind-blowing to us that there may be intelligent aliens in the
% universe. Many people perceive this idea as crazy. Or that a machine
% intelligence may possibly experience emotions that are truly equivalent to our
% own emotions. But if we strip away the certainty in the notion ``we are alone
...
% and a two-frog pond. It's both more mundane --- and more possible --- than we
% may first believe.
%
% A part of our human psychology seems to push back against the unknown. It
% feels somehow bad to let go of the ideal of supertruth and to accept effective
% truth. There is a part of us that doesn't want our place in the world to
% shrink. We want to be special. Yet there's something beautiful in being just
% like anything else in the world. Just with a shift in perspective, we become
...
% 
% (no segue, I think) answer 1:
% From my whiteboard: We are living beings with goals. Some patterns
% of thought tend to help us achieve those goals. They're effective. We call
% these effective patterns {\em truths}.
%
