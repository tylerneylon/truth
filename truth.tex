...
\begin{obs}\label{o8}
    ...
    more
    important to the idea than in finding a theoretically singular ``right'' way
    to achieve the social goal.
\end{obs}

The justification of this observation is a simple chain of connecting together
the key definitions:
...
\begin{argt}[That Social Ideas are Arbitrary]
    ...
    \begin{itemize}
        ...
        \item A social {\em idea} is one motivated by a social goal.
        \item Combining the above: Social ideas,
            being motivated by a need for agreement, 
            always have an arbitrary element. For example, what we call a
...
rather than being entirely objective, passive observations of the world.
In some cases, such as traffic laws, it is not at all surprising to see human
decisions as part of what we consider to be true. But in other cases, we may be
surprised. 
...
can cause people to make arbitrary decisions --- eg, in this weird case, we'll
...
$a,b,c$ of a right triangle with hypotenuse $c$. However, there is a {\em
choice} even here: we are assuming the world of plane geometry. Because
mathematical plane geometry is part of the mind, and not of the physical world,
...
({\em on} or {\em off), or we can think of a 2x2
...
equivalent. If we apply some principle like Occam's razor to say one is superior
