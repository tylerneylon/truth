...
\medskip
\centerline{$\cdot \quad \cdot \quad \cdot \quad \cdot \quad \cdot$}
\medskip
...
If we accept the definition of effective truth, or the definition of
evolutionary truth, then one consequence is that ideas no longer live in a
dichotomy of being absolutely true or absolutely false. But we can still
mathematically consider a model of thought in which ideas can only have these
two values, and nothing in between. I'm going to consider this alternate version
