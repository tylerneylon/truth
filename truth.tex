...
with one particular agent in the world. You see this agent in the world you
...
\begin{equation}\label{eq2}
    \text{\em Physical goals make no sense for the physically omniscient.}
\end{equation}
...
party, exist in some outer world, outside the confines of the world you know.
