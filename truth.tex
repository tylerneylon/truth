...
other approximations for reality as true in the same sense.
...
I imagine many people have a sense that an idea being true is:
\begin{itemize}
    \item Independent of minds. That is, whether an idea is true has nothing to
        do with anybody asking the question.
    \item Context-free. That is, whether an idea is true does not depend on
...
world, without the need for any perception or conscious creation of that object.
I'll use the word {\em invented} for everything else; in other words, I'll call
something invented when it would not exist without perception or conscious
creation.
It's not clear if the traditional idea of invention would apply to bird's nests,
for example, but I'm shifting definitions so that they count as invented since
they would not exist without being consciously created by birds.
...
% HERE
%
% Get as cleanly as possible to an argument that truth is an invented idea.
