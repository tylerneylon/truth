...
but then you can end up with gibberish like ``a yellow sadness confused the used
...
from the possiblities of having a gobsmacking day or a dog-tired day.
If there were no alternatives, then there is no information conveyed. If I said
``red is red,'' without context, then it's confusing because it's not clear what
alternative is being omitted.
...
idea is an answer to this question ($x=4$). If you say ``my name is Inigo,''
...
the speaker. I claim that if we {\em did} stop and think about any statement we
make, we would realize that either we had alternatives in mind to distinguish
from, or we would realize that we had not said anything meaningful (``red is
red''). Another imperfection with the analogy is the fact that mathematical
...
An idea has meaning only because it expresses one way things are amongst a
(non-mathematical) set of possible ways things could be.
