...
nothing unknown that makes sense as a question --- we get back to questions
that feel like
``is blue blue?''
...
abstract ideas; this abstraction allows for curiosity.
...
Specify the inputs, and the outputs are certain.
...
% HERE More up-front context for the observation.
