...
In a very real sense, when you know the full physical state of the world, it's a
bit like listing all possible worlds $\{x_1, x_2, \ldots\}$ in a giant list, and
then asking which possible world is the real one. When you're omniscient, you
know there's a particular number $k$ that indicates the real world $x_k$.

I'm going to pose a strange-seeming mathematical question, and the purpose of
this question is (a) to show that some math questions make us wonder what the
...
Given any number, I'll write its binary (base 2) form on the top of a table,
and then below that its base 3 form, then its base 4 form, and so on, keeping
them all right-aligned. Here's a table for the number 321:

\begin{center}
\begin{tabular}{ccccccccc|c}
      &   &   &   &   &   &   &   &  & \em base \\
    1 & 0 & 1 & 0 & 0 & 0 & 0 & 0 & 1 & \it 2 \\
      &   &   & 1 & 0 & 2 & 2 & 2 & 0 & \it 3 \\
      &   &   &   & 1 & 1 & 0 & 0 & 1 & \it 4 \\
      &   &   &   &   & 2 & 2 & 4 & 1 & \it 5 \\
      &   &   &   &   & 1 & 2 & 5 & 3 & \it 6 \\
...
% TODO This next sentence doesn't feel well-reasoned to me.

But such an outside world is a distraction to this thought experiment, where we
are learning about the role of knowledge in how we think.

% HERE
%
% * I'm leading up to a statement that mental words are unmotivated.
% * Next I might address math vs reality, saying we can imagine knowing either
%   or both. In this context, they are like two coexisting worlds.
% * And really the main observation of this subsection is that, without
%   ignorance, questions about what we see are nonsensical, and derived mental
%   words are unmotivated. Hence, again, ideas simply do not make sense without
%   ignorance.
% * I could end by saying that the notion of truth is a mental word, and that
%   this solidifies the above argument saying that truth is an invented (created
%   for a purpose) notion.
%
...
% HERE 1
%
% I'm in a tricky place, and I want to get back to a better baseline.
% * 4.4 and 5.1 have too much overlap. Think carefully about the outline of the
%   article and decide what I want to be where, then edit down.
%   [DONE]
% * I don't feel like I have a solid direction in the omniscience subsection.
%   Decide what I really want to say, concretely, and then focus down to that.
%   It may be a good idea to have in mind the main point of the next section and
%   a segue as well.
%   [NOT YET DONE]
%
...
% HERE 2 ; See also the notes in my remarkable.
%
