...
Let's look at another intuition we tend to have about truth.
...
\begin{enumerate}
    ...
    \item{} [The Intrinsic Property]
        ...
        Example: It seems silly if I point to a tree and ask if we got the
        notion of trees wrong, and maybe we should redefine {\em tree} to
        exclude this one.
        Trees are trees and flower are not trees; these
        distinctions are part of nature, and not our decisions.
\end{enumerate}
