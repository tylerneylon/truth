...
contains hidden-but-present numbers that we will uncover with time and thought.

I'll summarize this perspective as:
...
I'll summarize the above argument as:
\begin{obs}\label{o9}
    Truth is not the foundation of human knowledge.
\end{obs}

This leads us to wonder:
\begin{question}
    What is the foundation of human knowledge?
\end{question}
I won't try to answer that question in this article.
