...
the color green from our meaning of an idea. 
In this section I'll start to use the term {\em mental word} to talk about
things like the color green;
mental words are
pieces of ideas we can take apart and put together again to get
...
Where do mental words come from?
Perhaps external ideas (perceptions, thoughts of others, or associations) might
play a role in brining about new mental words.
For example, we cannot learn the sound of a
ambulance siren
without perception.
At the same time, you probably know to drive out of the way of an ambulance when
you hear its siren.
We have a mental word --- {\em siren} --- and a goal that motivates us to learn
it --- {\em obey traffic laws}.
...
\begin{tikzpicture}[node distance = 2cm, thick]%
    ...
    \draw[->] (1, -0.5) .. controls (1.4, -1.35) .. (1, -2.2) node[pos=0.5,
    right] {make};
    \draw[<-] (-1, -0.5) .. controls (-1.4, -1.35) .. (-1, -2.2) node[pos=0.5,
    left] {make};
