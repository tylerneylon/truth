...
\centerline{
This book explores the question: {\em What is truth?}
}
...
What kinds of things can be true or false --- can any sentence be true?
Any thought?
Can fictional ideas be true in some sense?
How objective is truth?

These questions are both philosophical and useful in
studying the future of science, science being
the study of what we can be confident is true
about the world.

At the heart of this short book is the idea that
truth is not as objective and clear-cut as we
might assume. This makes it a far richer
subject than it would otherwise be.

Our journey begins with curiosity, meanders
through ideas of invention, omniscience, 
and the foundations of knowledge. Ten
observations serve as waypoints along the way.
In the end, I cannot claim to have uncovered
complete and perfect answers, but I will provide
perspectives that shed light on each of the
key questions, including an understanding
of what truth itself is.
